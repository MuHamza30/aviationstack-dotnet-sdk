// <copyright file="AirportsController.cs" company="APIMatic">
...
namespace Aviationstack.Standard.Controllers
{
    ...
    public class AirportsController : BaseController
    {
        ...
        /// </summary>
        internal AirportsController(GlobalConfiguration globalConfiguration) : base(globalConfiguration) { }
        ...
        /// <param name="iataCode">Optional parameter: IATA code of the airport.</param>
        /// <param name="icaoCode">Optional parameter: ICAO code of the airport.</param>
        /// <param name="countryCode">Optional parameter: Country code.</param>
        /// <param name="cityName">Optional parameter: City name.</param>
        /// <returns>Returns the Models.AirportResponse response from the API call.</returns>
        public Models.AirportResponse GetAirports(
                string accessKey,
                int? limit = 100,
                int? offset = 0,
            ...
            => CoreHelper.RunTask(GetAirportsAsync(accessKey, limit, offset, iataCode, icaoCode, countryCode, cityName));
        ...
        /// <returns>Returns the Models.AirportResponse response from the API call.</returns>
        public async Task<Models.AirportResponse> GetAirportsAsync(
                string accessKey,
                int? limit = 100,
                int? offset = 0,
                string iataCode = null,
            ...
            => await CreateApiCall<Models.AirportResponse>()
              .RequestBuilder(_requestBuilder => _requestBuilder
                  .Setup(HttpMethod.Get, "/v1/airports")
                  .WithAuth("ApiKeyAuth")
